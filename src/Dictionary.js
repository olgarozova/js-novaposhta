class Dictionary {
  constructor() {
    this.words = {
      ...
      "14 symbols only. First symbol should be 5,2 or 1. Only numbers":
        "Тільки 14 символів. Перший символ повинен бути 5,2 або 1. Тільки цифри",
    ...
    this.containerIds = [
      ...
      "tab2-link-title",
      "ttns-history-title",
      "tab1-container-title",
      "tab2-container-title",
      "ttn_number__error",
      "ttn-status-submit",
      "ttn_number",
      "cityName",
      "search-warehouses-submit",
    ];
  }
