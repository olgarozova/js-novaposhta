...
class WarehouseSchedule {
  ...
  render() {
    ...
    this.ElementScheduleList.classList.add(
      "search-warehouses__item-schedule-list"
    );
    this.ElementScheduleList.append(...schedule);

    this.ElementScheduleOpen.classList.add(
      "search-warehouses__item-schedule-arrow"
    );
    ...
    this.ElementScheduleOpen.onclick = function () {
      this.parentElement.classList.toggle(
        "search-warehouses__item-schedule-open"
      );
    };

    this.ElementSchedule.classList.add("search-warehouses__item-schedule");
    this.ElementSchedule.append(
      this.ElementScheduleOpen,
      this.ElementScheduleList
    );
